                ...
                <form class="form-horizontal" name="resultado-atualiza" method="POST" action="ajax/resultadopdi/persisteresultini.php">
                   <table>
                    ...
                    <tr>
                        <td>
                            Capacitação </td>
                        <td>  <input class="form-control"type="radio" name="capacitacao" value="0">0
                              <input class="form-control"type="radio" name="capacitacao" value="1">1
                              <input class="form-control"type="radio" name="capacitacao" value="2">2
                              <input class="form-control"type="radio" name="capacitacao" value="3">3
                              <input class="form-control"type="radio" name="capacitacao" value="4">4
                              <input class="form-control"type="radio" name="capacitacao" value="5">5<br>
                       ...
                       <td>Recursos de Tecnologia da Informação
                        ...
                        <td><input class="form-control"type="radio" name="recti" value="0">0
                              <input class="form-control"type="radio" name="recti" value="1">1
                              <input class="form-control"type="radio" name="recti" value="2">2
                              <input class="form-control"type="radio" name="recti" value="3">3
                              <input class="form-control"type="radio" name="recti" value="4">4
                              <input class="form-control"type="radio" name="recti" value="5">5<br></td>
                       </tr>
                        <tr>
                       <td>Infraestrutura Física
                         </td>
                        <td><input class="form-control"type="radio" name="infraf" value="0">0  
                              <input class="form-control"type="radio" name="infraf" value="1">1  
                              <input class="form-control"type="radio" name="infraf" value="2">2  
                              <input class="form-control"type="radio" name="infraf" value="3">3  
                              <input class="form-control"type="radio" name="infraf" value="4">4  
                              <input class="form-control"type="radio" name="infraf" value="5">5<br></td>
                       </tr>
                       <tr>
                        <td>Recursos financeiros
                         </td>
                        <td><input class="form-control"type="radio" name="recf" value="0">0  
                              <input class="form-control"type="radio" name="recf" value="1">1 
                              <input class="form-control"type="radio" name="recf" value="2">2  
                              <input class="form-control"type="radio" name="recf" value="3">3  
                              <input class="form-control"type="radio" name="recf" value="4">4  
                              <input class="form-control"type="radio" name="recf" value="5">5<br></td>
                       </tr>
                       <tr>
                        <td>Planejamento</td>
                        <td><input class="form-control"type="radio" name="plan" value="0">0  
                              <input class="form-control"type="radio" name="plan" value="1">1  
                              <input class="form-control"type="radio" name="plan" value="2">2  
                              <input class="form-control"type="radio" name="plan" value="3">3  
                              <input class="form-control"type="radio" name="plan" value="4">4  
                              <input class="form-control"type="radio" name="plan" value="5">5<br></td>
                       </tr>
                         <tr>
                        <td>Outros
                         </td>
                        <td> <input class="form-control"name="outro" type="text" maxlength=50 value=""><br>
                              <input class="form-control"type="radio" name="pfOutros" value="0">0  
                              <input class="form-control"type="radio" name="pfOutros" value="1">1 
                              <input class="form-control"type="radio" name="pfOutros" value="2">2  
                              <input class="form-control"type="radio" name="pfOutros" value="3">3  
                              <input class="form-control"type="radio" name="pfOutros" value="4">4  
                              <input class="form-control"type="radio" name="pfOutros" value="5">5</td>
                       </tr>
                          <tr><td>
                    ...
                    <div>
                        ...
                        <input class="form-control"type="hidden" name="periodoini" value="<?php print $periodo; ?>"/>
                 ...
                 <?php 
                     ...
                     if ($objmeta->getPeriodo()=='P' && $habilita=='Parcial' && $periodo==1) {?>
                        <input class="form-control"id="pdi-salvar" type="button" value="Gravar" class="btn btn-info" />
