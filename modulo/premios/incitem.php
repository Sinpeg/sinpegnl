    ...
    function direciona(botao) {
        switch (botao) {
            case 1:
                ...
                break;
            case 2:
                document.forms[0].action = "?modulo=premios&acao=incitem";
                document.forms[0].submit();
                break;
        }
    }
...
<head>
	<div class="bs-example">
		<ul class="breadcrumb">
		    ...
		    <li><a href="<?php echo Utils::createLink("premios", "consultaitem"); ?>">Consulta</a></li>
			<li class="active">Inserir</li>
		</ul>
	</div>
</head>
<form class="form-horizontal" name="pre" method="post">
    <h3 class="card-title"> Pr&ecirc;mio</h3>
