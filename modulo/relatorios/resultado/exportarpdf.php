...
$daomapa = new MapaDAO();
$querrypdu = $daomapa->buscaPainelCompleto($codDocumento);
...
//colunas
$colunas = array('Objetivos Estrategicos PDI 2016-2025 UFPA', utf8_decode('Iniciativas Táticas'),utf8_decode('Situação'), 'Indicadores PDU', 'metas',utf8_decode('Análize Crítica'), utf8_decode('Semáforo'));
...
foreach ($querrypdu as $pdu){
	...
	$pdf->Row(array(utf8_decode($pdu['Objetivo']),utf8_decode($pdu['iniciativa']), utf8_decode($pdu['situacao']),utf8_decode($pdu['indicador']),utf8_decode($pdu['meta']), utf8_decode($pdu['analiseCritica'])));
