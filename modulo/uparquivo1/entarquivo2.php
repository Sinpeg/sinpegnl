...
<script language="JavaScript">
        ...
        <form class="form-horizontal" name="farquivo" id="farquivo" enctype="multipart/form-data"
            ...
            <h5>Envio de arquivo </h5>
            <h2>Esta aplica&ccedil;&atilde;o encontra-se em manuten&ccedil;&atilde;o, envie a parte textual do Relat&oacute;rio
            de Atividades pelo correio
            da UFPA, endere&ccedil;o sisraa@ufpa.br</h2>
