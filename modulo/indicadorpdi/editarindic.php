...
<fieldset>
    ...
    <form class="form-horizontal" name="adicionar" method="POST" action="ajax/indicadorpdi/registraindicador.php">
        <div id="resultado"></div>
        <div>
            <label>Indicador:</label>
            <input class="form-control"type="text" class="txt" name="indicador" value="<?php print ($objind->getIndicador()); ?>" size="60"/>
        </div>
        <div>
            <label>Documento: </label>
            <select class="custom-select" name="doc" id="doc-indicador" class="sel1">
        ...
        <div class="unidade">
            ...
            <select class="custom-select" name="unidade" class="sel1">
        ...
        <div>
            ...
            <input class="form-control"type="text" class="txt" name="calculo" value="<?php print ($objind->getCalculo()); ?>" size="60" />
        </div>
        <input class="form-control"type="hidden" value="E" name="acao" />
        <input class="form-control"type="hidden" name="codindicador" value="<?php print $codindicador ?>" />
        <div>
