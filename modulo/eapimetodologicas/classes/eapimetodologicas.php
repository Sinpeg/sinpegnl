...
class 	EApimetodologicas{
	...
	private $bolsistas;
	private $nbolsistas;
	private $posgraduacao;
	private $outras;
	private $ano;

	public function _construct($codigo,$execucao,$tramitacao,$cancelado,$suspenso,$concluido,$docentes,$tecnicos,$bolsistas,$nbolsistas,$posgraduacao,$outras,$ano) {
		$this->codigo = $codigo;
	...
	public function setBolsistas( $bolsistas){
		$this->bolsistas =$bolsistas;
	}

	public function getNBolsistas(){
		return $this->nbolsistas;
	}

	public function setNBolsistas( $nbolsistas){
		$this->nbolsistas =$nbolsistas;
	}
	...
	public function setPosgraduao( $posgraduacao){
		$this->posgraduacao =$posgraduacao;
	}
