...
class Laboratorio {
	...
	public function getAtendecursograd(){
	    return $this->atendecursograd;
	}
	
	public function setAtendecursograd($atendecursograd){
	    $this->atendecursograd = $atendecursograd;
	}
	...
	public function adicionaItemLabcursos($codigo,$Curso,$ano,$cont){
		$labcur= $this->criaLabcurso($codigo,$Curso,$ano);
		$this->Labcursos[$cont] = $labcur;
	}
	...
	public function criaLabcurso($codigo,$curso,$ano){
		$labcur = new Labcurso();
