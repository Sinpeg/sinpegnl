...
$rows = $daolab->buscaLaboratoriov1($_GET["codlab"]); // código do laboratório
$botao=true;
foreach ($rows as $row) {
...
<form class="form-horizontal" name="fgravar">
    ...
    <table>
       ...
       <textarea name="justificativa" placeholder="Insira uma justificativa, caso haja alteração da área em relaçao ao ano anterior" class="form-control" rows="5" id="justificativa"><?php echo $jus;?></textarea></td>
        ...
        <tr>
            <th colspan="2" align="left"><input class="form-check-input" type="checkbox"
        ...
        <tr>
            <th colspan="2" align="left"><input class="form-check-input"<?php echo $lock->getDisabled(); ?> type="checkbox" name="cabo[]" style="font-weight: normal;" id="cabo" <?php print $selecionado10; ?>/>Possui cabeamento
                estruturado
            </th>
        </tr>
    </table><br/>
