...
//ob_end_flush();
?>
<?php echo Utils::deleteModal('Calendário', 'Você tem certeza que deseja remover um ano de gestão?'); ?>
...
<?php if ($codunidade==100000){?>
	<div class="bs-example">
		<ul class="breadcrumb">
			...
			<li class="active">Listar Calendários</li>  
		</ul>
	</div>
	<?php }else{ ?>
		<div class="bs-example">
...
<form class="form-horizontal" method="POST" action="index.php?modulo=calendarioPdi&acao=finsCalend">
    ...
    <?php if ($cont > 0) { ?>
        ...
        print "<p style='color:red'>Nenhum calendário registrado para a unidade.</p></br>";
    }
    ?>
    <input class="btn btn-info" type="submit"   class="btn btn-info" value="Incluir Calendário" />
</form>
