...
foreach ($rows as $r){
 ?>
<tr><td><label>CPF</label></td><td><input class="form-control"type="text" class='form-control' name="cpf" disabled size="60" value="<?php print $login; ?>" /></td></tr>
<tr><td><label>Data de Nascimento</label></td><td><input class="form-control"type="text" class='form-control' name="nascimento" disabled size="60" value="<?php print $r['dtnascimento']; ?>" /></td></tr>
<tr><td><label>Nome</label></td><td><input class="form-control"type="text" class='form-control' name="nome" disabled size="60" value="<?php print $r['nome']; ?>" /></td></tr>
...
<tr><td><label>País de Origem</label></td><td><input class="form-control"type="text" class='form-control' name="nascimento" disabled size="60" value="<?php print "banco"; ?>" /></td></tr>
...
<tr><td><label>Deficiência, TGD/TEA ou altas habilidades/superdotação</label></td><td><input class="form-control"type = "checkbox"  name = "temdef" value = "1"></td></tr>
<tr><td><label>Tipo</label></td><td></td></tr>
 <tr> <td><input class="form-control"type = "checkbox" <?php echo $r['cegueira']=="1"?'checked':"";?> name = "cegueira" value = "1"></td><td>Cegueira</td></tr>
  <tr><td><input class="form-control"type = "checkbox" <?php echo $r['baixavisao']=="1"?'checked':"";?> name = "tipodef" value = "2"></td><td>Baixa visão</td></tr>
 <tr> <td><input class="form-control"type = "checkbox" <?php echo $r['surdez']=="1"?'checked':"";?> name = "tipodef" value = "3"></td><td>Surdez</td></tr>
  <tr><td><input class="form-control"type = "checkbox" <?php echo $r['auditiva']=="1"?'checked':"";?> name = "tipodef" value = "4"></td><td>Auditiva</td></tr>
 <tr> <td><input class="form-control"type = "checkbox" <?php echo $r['fisica']=="1"?'checked':"";?> name = "tipodef" value = "5"></td><td>Física</td></tr>
  <tr><td><input class="form-control"type = "checkbox" <?php echo $r['surdocegueira']=="1"?'checked':"";?> name = "tipodef" value = "6"></td><td>Surdocegueira</td></tr>
 <tr> <td><input class="form-control"type = "checkbox" <?php echo $r['mental']=="1"?'checked':"";?> name = "tipodef" value = "7"></td><td>Intelectual</td></tr>
 <tr><td> <input class="form-control"type = "checkbox" <?php echo $r['autismoinfantil']=="1"?'checked':"";?> name = "tipodef" value = "8"></td><td>Transtorno global do desenvolvimento (TGD)/Transtorno do Espectro Autista (TEA)</td></tr>
 <tr><td> <input class="form-control"type = "checkbox" <?php echo $r['altashabilidades']=="1"?'checked':"";?> name = "tipodef" value = "9"></td><td>Altas habilidades/ superdotação</td></tr>
<?php 
$idpessoa=$r['idPessoa'];
...
foreach ($rows as $r){?>
            ...
            <tr> <td><label>Situação do Docente na IES</label></td><td>             
             ...
             <tr> <td><label>Docente esteve em exercício em 31/12?</label></td><td>   
              ...
              <option <?php echo $r['regime']=="4"?'selected':"";?> value="4">Horista</option>
                 ...
                 <input class="form-control"type = "checkbox"   <?php echo $r['substituto']=="1"?'checked':"";?>  name = "substituto" value = "0">
               
                
               </td> </tr>       
                          <tr> <td><label>  Docente Visitante   </label></td><td>             
                 <input class="form-control"type = "checkbox"  <?php echo $r['visitante']=="1"?'checked':"";?> name = "visitante" value = "0">
              ...
              <option <?php echo $r['vinculovisitante']=="2"?'selected':"";?>  value="2">Bolsista</option>
               ...
               <tr><td><label>Atuação</label></td><td></td></tr>
                  <tr><td>Ensino de pós-graduação stricto sensu presencial</td><td><input class="form-control"type = "checkbox" <?php echo $r['atpossspresencial']=="1"?'checked':"";?> name = "atpossspresencial" value = "0"></td></tr>
                  <tr><td>Ensino de pós-graduação stricto sensu a distância</td><td><input class="form-control"type = "checkbox" <?php echo $r['atposssEAD']=="1"?'checked':"";?> name = "atposssEAD" value = "0"></td></tr>
                  <tr><td>Pesquisa</td><td><input class="form-control"type = "checkbox"  <?php echo $r['atpesquisa']=="1"?'checked':"";?> name = "atpesquisa" value = "0"></td></tr>
                  <tr><td>Recebeu Bolsa de Pesquisa?</td><td><input class="form-control"<?php echo $r['bolsapesquisa']=="1"?'checked':"";?> type = "checkbox"  name = "bolsapesquisa" value = "0"></td></tr>
                  <tr><td>Extensão</td><td><input class="form-control"type = "checkbox"  <?php echo $r['atextensao']=="1"?'checked':"";?> name = "atextensao" value = "0"></td></tr>
                  <tr><td>Gestão, planejamento e avaliação</td><td><input class="form-control"type = "checkbox" <?php echo $r['atgpa']=="1"?'checked':"";?> name = "atgpa" value = "0"></td></tr>
      ...
      <tr><td>Cursos de Graduação em que atuou</td><td></td></tr>
         <tr><td>Ensino em curso de graduação presencial</td><td><input class="form-control"type = "checkbox" <?php echo $r['atgpresencial']=="1"?'checked':"";?> name = "atgpresencial" value = "0"></td></tr>
         <tr><td>Ensino em curso de graduação a distância</td><td><input class="form-control"type = "checkbox" <?php echo $r['atgEAD']=="1"?'checked':"";?> name = "atgEAD" value = "0"></td></tr>
   ...
   <td><button style="float:left;" class="btn btn-info">Incluir</button></td></tr> 
...
?>
  ...
  <?php 
                ...
                <div>
                    ...
                    <input type="button" id="botdoc" value="Gravar" name="salvar" class="btn btn-info btn"/>
...
$(function(){
	  AddTableRow = function() {
	    ...
	    if (valor!=0){
	 	    ...
	 	    cols += '<td>'+texto+'<input class="form-control"type="hidden" name="indsel[]"  value="'+valor+'"></td>';

            <?php for ($ano=$anobase;$ano<=$docobj->getAnofinal();$ano++){?>
	 	    cols += '<td><input class="form-control"type="text" maxlength=8 class="form_control" size=7 onKeyPress="tecla()" autocomplete="off" value=""  name="meta'+<?php echo $ano;?>+'[]"></td>';
	 	    <?php } ?>
	 	   
	 	    cols += '<td><select class="custom-select" name="metrica[]" id="metrica"  style = "width:170px" >'+           
