                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            if ($objini[$j]->getResultiniciativa()!=NULL){
                              echo $objini[$j]->getResultiniciativa()->getSituacao()==1?"Não iniciado":""; 
                              echo $objini[$j]->getResultiniciativa()->getSituacao()==2?"Em atraso":"";  
                              echo $objini[$j]->getResultiniciativa()->getSituacao()==3?"Com atrasos crítico":"";   
                              echo $objini[$j]->getResultiniciativa()->getSituacao()==4?"Em andamento normal":"";  
                              echo $objini[$j]->getResultiniciativa()->getSituacao()==5?"Concluído":"";
                            }else{
                            	echo "sem resultado";
                            }  ?> 
                           </td>
