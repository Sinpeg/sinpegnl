    ...
    if ($row->rowCount() == 0) {
        ...
        <table id="tablesorter" class="table table-bordered table-hover"> 
            <thead> 
                <tr> 
                    ...
                    <th>Subunidade</th> 
                    <th>Uso Academico</th> 
                    <th>Uso Academico(s/ internet)</th> 
                    <th>Uso Administrativo</th>
                    <th>Uso Administrativo(s/ internet)</th>
                    <th>Ano</th>
                </tr> 
            </thead> 
            <tfoot> 
            ...
            <tbody> 
                <?php foreach ($row as $r) { ?> 
                    <tr>
                        ...
                        <td><?php echo $r['Subunidade']; ?></td>
                        <td><?php echo ($r['AcademicoInternet']); ?></td> 
                        <td><?php echo ($r['Academico']); ?></td> 
                        <td><?php echo $r['AdministrativoInternet']; ?></td>
                        <td><?php echo $r['Administrativo']; ?></td> 
        ...
        <div> 
            <form name="form1" method="POST" 
                  action="relatorio/micros/exportmicros.php" id="xls"> 
