...
if (!empty($unidades)){
	$passou=0;
   $display=  "<select multiple class='custom-select' id='select3' name='lista2[]' multiple size=multiple>";
  ...
  $display=" <select multiple class='custom-select' id='select3' name='lista2[]' multiple size=multiple></select>";
