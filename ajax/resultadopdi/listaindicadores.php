...
//echo $anobase.",".$coddocumento.",".$unidade->getCodunidade()." ".$sessao ->getCodunidsel();
$rows = $daodoc->listaIndporDocCal($anobase,$coddocumento,$sessao->getCodunidsel());//lista indicadores da unidade por doc e calendario
$objetoind = array();
$cont1 = 0;
foreach ($rows as $row) {
  //  for ($i = 0; $i < $cont; $i++) {
