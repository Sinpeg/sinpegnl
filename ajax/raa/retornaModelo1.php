...
if((date("d-m-Y") < strtotime('14-01-2022') && $t->getCodigo()==145) ){
print '<div class="alert alert-warning" role="alert">As informações estaram disponíveis a partir do dia 14/01/2022, devido ao fechamento do SIAFI.</div>';
...
<input type="button" name="acao" <?php print $disabled;?> value="Gravar"  id="gravatopico<?php print $t->getCodigo();?>"  class="btn btn-primary btn">
<?php 
