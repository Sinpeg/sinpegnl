...
//if((date("d-m-Y") <= strtotime('17-01-2020') && $t->getCodigo()==145) ){
//print '<div class="alert alert-warning" role="alert">As informações estaram disponíveis a partir do dia 17/01/2020.</div>';	
...
<br/>
<?php if($t->getCodigo()!=2 && $t->getCodigo()!=3 && $t->getCodigo()!=5 && $flagNaoResult==0){?>
