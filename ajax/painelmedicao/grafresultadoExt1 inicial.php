...
$rows1 = $daodoc->painelSituacaoIniciativas(2,$codunidade,$periodo,$codcal);
$rows2 = $daodoc->painelFatoresIniciativas(2,$codunidade,$codcal,$periodo);
/*foreach ($rows as $r){ 
            echo $r['sit'].'<br>';
          }*/
...
<link rel="stylesheet" href="http:/resources/demos/style.css">
   ...
   <div id="dialog" title="SisRAA - Indicadores - Desempenho" style="display:none;">
