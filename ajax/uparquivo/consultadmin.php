...
$data1 = explode ( '-', $u->getDatainclusao () );
				...
				<td align="center">
				<!--  <a href="?modulo=uparquivo&acao=downarquivo&codigo=<?php // print  $u->getCodigo();?>"
			 ...
			 -->
			  ...
			  <?php //if ($usuarios[$j]->getResponsavel() == $responsavel ) { 
				if ($ano<2021){?>
                                <a href="<?php print "?modulo=uparquivo&acao=downarquivo&codigo=".$u->getCodigo(); ?>"
                                 target="_self"><img
                                        src="webroot/img/download.jpg"
                                        alt="Excluir" width="19" height="19" /> </a>
                                <?php } else {?>
                               	<a href="<?php print "../public/raa_anexos1/ano".$ano.'/'.$u->getNome()  ?>"
