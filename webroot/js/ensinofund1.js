function valida() {
    var passou = false;
    var em1 = document.ensino.elements["em[]"];
    var ea1 = document.ensino.elements["ea[]"];
    var er1 = document.ensino.elements["er[]"];
    var pe1 = document.ensino.elements["p1[]"];
    var pe2 = document.ensino.elements["p2[]"];
...
function direciona(botao) {
    switch (botao) {
        case 1:
            if (valida()) {
                document.getElementById('ensino').action = "?modulo=ensinofund&acao=opensino";
                document.getElementById('ensino').submit();
            }
            break;
        case 2:
            document.getElementById('ensino').action = "../saida/saida.php";
            document.getElementById('ensino').submit();
            break;
        case 3:
            document.getElementById('ensino').action = "?modulo=ensinofund&acao=altensino";
            document.getElementById('ensino').submit();
            break;
    }
}
...
function percentagem() {
    ...
    var ea1 = document.ensino.elements["ea[]"];
    var er1 = document.ensino.elements["er[]"];
    var p1 = document.ensino.elements["p1[]"];
    var p2 = document.ensino.elements["p2[]"];
