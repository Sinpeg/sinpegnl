...
function direcionaAlt(botao) {
    ...
    if (!passou) {//Enviar formulário com os dados do laboratório
        /* Comentado - 29/08/18
    	document.fgravar.action = "index.php?modulo=laborv3&acao=oplab";
        document.fgravar.submit();
		*/ 
    	   //alert("teste");
    	   url = "ajax/laborv3/alteraLab.php"; //Caminho 
    	   ...
    	   $.ajax({
    	       ...
    	       success: function(data) {
    	    	   window.location="?modulo=laborv3&acao=consultalab";
    	    	   //alert(data);
    	       },
...
function direcionacurso(valor,codLab) {
    if (valor == 1) {
        document.fconsultar.action = "?modulo=laborv3&acao=inccursolab&codlab="+codLab;
