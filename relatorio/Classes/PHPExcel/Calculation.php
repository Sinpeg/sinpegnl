...
//        }
    ...
    private function validateBinaryOperand($cellID, &$operand, &$stack): bool
    {
    ...
    private function executeBinaryComparisonOperation($cellID, $operand1, $operand2, $operation, &$stack, $recursingArrays = false): bool
    {
    ...
    private function executeNumericBinaryOperation($cellID, $operand1, $operand2, $operation, $matrixFunction, &$stack): bool
    {
