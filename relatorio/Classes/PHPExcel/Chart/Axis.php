...
class Axis extends \PHPExcel_Chart_Properties
{
    ...
    public function setAxisOptionsProperties($axis_labels, $horizontal_crosses_value = \null, $horizontal_crosses = \null, $axis_orientation = \null, $major_tmt = \null, $minor_tmt = \null, $minimum = \null, $maximum = \null, $major_unit = \null, $minor_unit = \null)
    {
        ...
        if ($horizontal_crosses_value !== \null) {
            $this->axisOptions['horizontal_crosses_value'] = (string) $horizontal_crosses_value;
        }
        if ($horizontal_crosses !== \null) {
            $this->axisOptions['horizontal_crosses'] = (string) $horizontal_crosses;
        }
        if ($axis_orientation !== \null) {
        ...
        if ($minimum !== \null) {
            $this->axisOptions['minimum'] = (string) $minimum;
        }
        if ($maximum !== \null) {
            $this->axisOptions['maximum'] = (string) $maximum;
        }
        if ($major_unit !== \null) {
    ...
    {
        if (!\is_null($line_width)) {
            $this->lineStyleProperties['width'] = $this->getExcelPointsWidth((float) $line_width);
        }
        if (!\is_null($compound_type)) {
            $this->lineStyleProperties['compound'] = (string) $compound_type;
        }
        if (!\is_null($dash_type)) {
            $this->lineStyleProperties['dash'] = (string) $dash_type;
        }
        if (!\is_null($cap_type)) {
            $this->lineStyleProperties['cap'] = (string) $cap_type;
        }
        if (!\is_null($join_type)) {
            $this->lineStyleProperties['join'] = (string) $join_type;
        }
        if (!\is_null($head_arrow_type)) {
            $this->lineStyleProperties['arrow']['head']['type'] = (string) $head_arrow_type;
        }
        if (!\is_null($head_arrow_size)) {
            $this->lineStyleProperties['arrow']['head']['size'] = (string) $head_arrow_size;
        }
        if (!\is_null($end_arrow_type)) {
            $this->lineStyleProperties['arrow']['end']['type'] = (string) $end_arrow_type;
        }
        if (!\is_null($end_arrow_size)) {
            $this->lineStyleProperties['arrow']['end']['size'] = (string) $end_arrow_size;
        }
    }
