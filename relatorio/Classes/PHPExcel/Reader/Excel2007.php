...
{
    /**
     * @var PHPExcel_Reader_DefaultReadFilter
     */
    public $readFilter;
    public $readDataOnly;
    public $loadSheetsOnly;
    public $includeCharts;
    /**
     * PHPExcel_ReferenceHelper instance
     */
    private \PHPExcel_ReferenceHelper $referenceHelper;
        ...
        foreach ($rels->Relationship as $rel) {
            switch ($rel["Type"]) {
                ...
                case "http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument":
                    ...
                    // Set base date
                    if ($xmlWorkbook->workbookPr !== null) {
                    ...
                    if ($xmlWorkbook->sheets !== null) {
                        foreach ($xmlWorkbook->sheets->sheet as $eleSheet) {
                            ...
                            // Check if sheet should be skipped
                            if (property_exists($this, 'loadSheetsOnly') && $this->loadSheetsOnly !== null && !in_array((string) $eleSheet["name"], $this->loadSheetsOnly)) {
                                ++$countSkippedSheets;
...
//                                                echo 'Default', PHP_EOL;
    ...
    //                                    echo 'Value is ', $value, PHP_EOL;
                            ...
                            if (!$this->readDataOnly && $xmlSheet && $xmlSheet->sheetProtection) {
                                ...
                                if ($xmlSheet->protectedRanges->protectedRange !== null) {
                            ...
                            if ($zip->locateName(dirname("$dir/$fileWorksheet") . "/_rels/" . basename($fileWorksheet) . ".rels")) {
                                ...
                                if ($xmlSheet->drawing && !$this->readDataOnly) {
                                    foreach ($xmlSheet->drawing as $drawing) {
                                        ...
                                        if ($xmlDrawing->oneCellAnchor !== null) {
                                            foreach ($xmlDrawing->oneCellAnchor as $oneCellAnchor) {
                                                if ($oneCellAnchor->pic->blipFill !== null) {
                                        ...
                                        if ($xmlDrawing->twoCellAnchor !== null) {
                                            foreach ($xmlDrawing->twoCellAnchor as $twoCellAnchor) {
                                                if ($twoCellAnchor->pic->blipFill !== null) {
                            ...
                            if ($xmlWorkbook->definedNames !== null) {
