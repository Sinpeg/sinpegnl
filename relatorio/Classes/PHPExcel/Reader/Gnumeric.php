...
//            echo '<b>Worksheet: ', $worksheetName,'</b><br />';
            if ((property_exists($this, 'loadSheetsOnly') && $this->loadSheetsOnly !== null) && (!in_array($worksheetName, $this->loadSheetsOnly))) {
                continue;
            }
            ...
            if ((!$this->readDataOnly) && (property_exists($sheet, 'PrintInformation') && $sheet->PrintInformation !== null) && isset($sheet->PrintInformation->Margins)) {
...
//                        echo 'New Value is ', $cell,'<br />';
            ...
            if ((!$this->readDataOnly) && (property_exists($sheet, 'Objects') && $sheet->Objects !== null)) {
                foreach ($sheet->Objects->children('gnm', true) as $key => $comment) {
                    ...
                    if ($commentAttributes->Text !== null) {
