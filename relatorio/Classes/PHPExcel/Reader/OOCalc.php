...
//            }
    ...
    private static function identifyFixedStyleValue($styleList, &$styleAttributeValue): bool
    {
...
//                echo '<br />';
                if ((property_exists($this, 'loadSheetsOnly') && $this->loadSheetsOnly !== null) && (isset($worksheetDataAttributes['name'])) &&
