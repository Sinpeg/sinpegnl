...
class PHPExcel_Writer_HTML extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
    ...
    private function createCSSStyleBorders(PHPExcel_Style_Borders $pStyle)
    {
        return [
            // Create CSS
            'border-bottom' => $this->createCSSStyleBorder($pStyle->getBottom()),
            'border-top' => $this->createCSSStyleBorder($pStyle->getTop()),
            'border-left' => $this->createCSSStyleBorder($pStyle->getLeft()),
            'border-right' => $this->createCSSStyleBorder($pStyle->getRight()),
        ];
    }
