...
class PHPExcel_Writer_Excel5_Xf
{
     ...
     */
    private int $textJustLast = 0;

    /**
     * The cell's foreground color.
     */
    private int $foregroundColor = 0x40;

    /**
     * The cell's background color.
     */
    private int $backgroundColor = 0x41;

    /**
     * Color of the bottom border of the cell.
     */
    private int $bottomBorderColor = 0x40;

    /**
     * Color of the top border of the cell.
     */
    private int $topBorderColor = 0x40;

    /**
     * Color of the left border of the cell.
     */
    private int $leftBorderColor = 0x40;

    /**
     * Color of the right border of the cell.
     */
    private int $rightBorderColor = 0x40;
