...
class PHPExcel_Writer_Excel5_Worksheet extends PHPExcel_Writer_Excel5_BIFFwriter
{
     ...
     */
    private int $xlsStringMaxLength = 255;
     ...
     */
    private array $selection = array(0,0,0,0);
     ...
     */
    private int $outlineBelow = 1;

    /**
     * Whether to have outline summary at the right.
     */
    private int $outlineRight = 1;
...
//            if ($row + 1 > 65536 or $column + 1 > 256) {
     ...
     */
    private function writeNote($row, $col, $note): int
    {
